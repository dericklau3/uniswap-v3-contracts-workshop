...
library TickBitmap {
    ...
    function position(int24 tick) private pure returns (int16 wordPos, uint8 bitPos) {
        ...
        // 通过 tick % 256 可以得到 tick 在字中的位置（0 到 255 之间的一个值）。
    ...
    function flipTick(
        ...
        // tickLower-78200 bitPos = 135, 那么 1 << bitPos = ""
        // tickUpper-84200 bitpos = 165, 那么 1 << bitPos = ""
        uint256 mask = 1 << bitPos;
        // ^运算 如果两位相同，结果为0；如果两位不同，结果为1。
        // tickLower存储时 self[wordPos] = ""
        // tickUpper存储时 self[wordPos] = ""
        self[wordPos] ^= mask;
    }
